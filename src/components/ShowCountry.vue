<template>
  <div>
    <div v-for="(country, index) in countries" v-if="id == index" class="country-container">
      <div class="row">
        <div class="col-md-12">
          <h2>{{country.name}}</h2>
        </div>
      ...
      <div class="row">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <th class="text-center">{{country.area}} km<sup>2</sup></th>
              </tr>
              <tr>
        ...
        <div class="col-md-4">
          <h3>Flag</h3>
          <img class="country-flag" v-bind:src="country.flag" v-bind:alt="country.name.toLowerCase() + ' flag'">
